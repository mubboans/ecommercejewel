...
import { getBanners, getActiveBanners } from "./actions";
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <div className="space-y-1">
                                ...
                                <p className="text-sm sm:text-base text-gray-600 max-w-2xl">
                                    Manage promotional banners displayed across your e-commerce store
                                </p>
                            </div>
                            <Button asChild className="w-full sm:w-auto">
                                <Link href="/admin/banners/new" className="flex items-center justify-center">
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-2xl font-bold text-gray-900 mt-1">
                                            {banners.filter((b: IBanner) => b.isActive).length}
                                        </p>
                                    </div>
